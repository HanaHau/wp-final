...
### 陳奕蓁
起初討論出這個記帳結合寵物的概念後，覺得能將需要日常持續又吸引人的養成玩法，加上很重要卻常常會被遺忘的記帳功能，應該會很實用！實際著手後才發現，從設計背後邏輯，到如何真的用程式碼實踐，都是不容易的工作。究竟該怎麼做，才能夠讓使用者願意依據實際情況輸入，而非為了達成任務而胡亂記錄呢？要怎麼在記帳的同時，又不失電子雞系養成的樂趣呢？在設計與實踐的過程，感覺自己不只是個「開發者」，更需要成為「使用者」，才能創造出更好的作品。此外，和組員之間的協作、程式碼的書寫與修正，也都是在專案製作過程中，讓我獲益良多之處。很謝謝能和組員們一起分工合作，完成這一份專案，也希望在未來，這個網頁應用能夠變得越來越好，讓更多人體會記帳與寵物養成的美妙！
